...
- **WebGL:** texelFetch from R32I with shift+mask in GLSL. Float16 emulation pending (Phase 2 of `Plans/f16-emulation-plan.md`) - capability reports false today.
...
| f16 native | Native or emulated** | Not yet*** | No (emulated) | Yes | Yes**** | Yes |
...
***WebGL f16: capability still reports false; emulation pending (Phase 2 of `Plans/f16-emulation-plan.md`). Sub-word Float16 buffer storage already works; the remaining work is the GLSL bit-conversion helpers + Transform Feedback readback path.
