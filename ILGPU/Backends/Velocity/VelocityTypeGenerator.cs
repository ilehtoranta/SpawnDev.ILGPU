...
namespace ILGPU.Backends.IL
{
    ...
    abstract class VelocityTypeGenerator : DisposeBase
    {
        ...
        private readonly struct VectorizedTypeProvider : IExtendedTypeProvider
        {
            ...
            /// </summary>
            public Type GetPrimitiveType(PrimitiveType primitiveType) =>
                parent.GetVectorizedBasicType(primitiveType.BasicValueType);
            ...
            /// </summary>
            public Type GetPointerType(PointerType pointerType) =>
                parent.GetVectorizedBasicType(BasicValueType.Int64);
            ...
            where TTypeProvider : IManagedTypeProvider
        {
            ...
            return typeSelector(mappedType.Linear, mappedType.Vectorized).AsNotNull();
        }
        ...
        /// </summary>
        public abstract Type GetVectorizedBasicType(BasicValueType basicValueType);
