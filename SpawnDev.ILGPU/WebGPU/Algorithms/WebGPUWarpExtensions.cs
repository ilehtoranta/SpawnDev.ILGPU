...
//
// File: WebGPUWarpExtensions.cs
//
// WebGPU-specific warp-level scan and reduce implementations.
// Uses SharedMemory fallbacks since WGSL subgroup scan/reduce may not be
...
{
    /// <summary>
    /// Custom WebGPU-specific warp-level implementations.
    /// Implemented using shared memory fallbacks — no warp shuffle required.
    /// </summary>
    static class WebGPUWarpExtensions
    {
        #region Reduce
